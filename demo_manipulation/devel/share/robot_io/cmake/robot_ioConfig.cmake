...
if("TRUE" STREQUAL "TRUE")
  set(robot_io_SOURCE_PREFIX /home/conghui/industrial_training/training/ref/demo_manipulation/src/robot_io)
  set(robot_io_DEVEL_PREFIX /home/conghui/industrial_training/training/ref/demo_manipulation/devel)
  set(robot_io_INSTALL_PREFIX "")
  set(robot_io_PREFIX ${robot_io_DEVEL_PREFIX})
else()
  set(robot_io_SOURCE_PREFIX "")
  set(robot_io_DEVEL_PREFIX "")
  set(robot_io_INSTALL_PREFIX /home/conghui/industrial_training/training/ref/demo_manipulation/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_io' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'jnicho <jnicho@swri.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_io' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/conghui/industrial_training/training/ref/demo_manipulation/src/robot_io/${idir}'.  Ask the maintainer 'jnicho <jnicho@swri.org>' to fix it.")
    endif()
...
set(robot_io_EXPORTED_TARGETS "robot_io_generate_messages_cpp;robot_io_generate_messages_lisp;robot_io_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${robot_io_dep}_FOUND)
      find_package(${robot_io_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robot_io_dep} REQUIRED ${depend_list})
  endif()
